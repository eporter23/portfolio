...
<title>Emily Porter: Web Projects</title>
<!-- InstanceEndEditable -->
...
<!-- #BeginLibraryItem "/Library/header.lbi" --><a id="logo" href="index.html"><img src="design/img/logo.png" alt="porter://portfolio"/></a><!-- #EndLibraryItem --><!-- #BeginLibraryItem "/Library/topnavPortfolio.lbi" --><nav id="primary-nav" role="navigation">
  ...
  <section id="main-content" role="main">
    <div id="content">
      <h1 id="heading"><!-- InstanceBeginEditable name="content-title" -->Web Projects<!-- InstanceEndEditable --></h1>
      <!-- InstanceBeginEditable name="content" --> <p>The following samples showcase visual design, information architecture,  interface design, system design, eLearning and web development skills in CSS, XHTML, HTML5, XML,  XSLT, PHP/MySQL, and Flash. </p>
      <!--rel="lightbox" -->
      <p><a class="nextlink" id="viewAll">View all projects as slideshow</a></p>
      <?php
		include('admin/mysqli/dbinclude17.php');
		//unique query page page - abstract this? otherwise identical -->
		$query="SELECT * from $table WHERE `categories`='Web' and `recordstatus`!='Inactive' ORDER BY `year` DESC";
