...
<title>Emily Porter: Experimental Digital Media Projects</title>
<!-- InstanceEndEditable -->
...
<!-- InstanceEndEditable -->
<!-- InstanceParam name="id" type="text" value="Experimental" -->
</head>
...
<!-- #BeginLibraryItem "/Library/header.lbi" --><a id="logo" href="index.html"><img src="design/img/logo.png" alt="porter://portfolio"/></a><!-- #EndLibraryItem --><!-- #BeginLibraryItem "/Library/topnavPortfolio.lbi" --><nav id="primary-nav" role="navigation">
  ...
  <section id="main-content" role="main">
    <div id="content">
      <h1 id="heading"><!-- InstanceBeginEditable name="content-title" -->Experimental Projects<!-- InstanceEndEditable --></h1>
      <!-- InstanceBeginEditable name="content" --><p>The following samples showcase experimental narrative/story concepts, interface design, multimedia, and video projects. </p>
      <!--rel="lightbox" -->
      <p><a class="nextlink" id="viewAll">View all projects as slideshow</a></p>
      <?php
		include('admin/mysqli/dbinclude17.php');
		$query="SELECT * from $table WHERE `categories`='Experimental' and `recordstatus`!='Inactive' ORDER BY `year` DESC";
